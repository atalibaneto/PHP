...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14/08/2023 às 22:27
...
INSERT INTO `jogos` (`id_jogo`, `nome`, `id_genero`, `id_produtora`, `descricao`, `nota`, `capa`) VALUES
...
INSERT INTO `produtoras` (`id_produtora`, `produtora`, `pais`) VALUES
(1, 'Microsoft', 'EUA'),
(2, 'Tencent', 'China'),
(3, 'Nintendo', 'Japão'),
(4, 'Sony', 'Japão'),
...
('admin', 'Administrador', '$2y$10$UpMQCcir.v649HrdLvUXiOC/ftU7xWhSxm8QhX.VzSe9LZHhvW/Ty', 'admin'),
('teste', 'John Doe', '$2y$10$w7on7cjLKNtmJUGkiHIXoOQAwTJzkgxXqLmjtfDUkCXmQK0784.IS', 'editor');
...
--
ALTER TABLE `produtoras`
  MODIFY `id_produtora` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `jogos`
  ADD CONSTRAINT `fk_id_genero` FOREIGN KEY (`id_genero`) REFERENCES `generos` (`id_genero`),
  ADD CONSTRAINT `fk_id_produtora` FOREIGN KEY (`id_produtora`) REFERENCES `produtoras` (`id_produtora`);
COMMIT;
